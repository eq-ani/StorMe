CREATE TABLE storme.bookings_db (
    ...
    FOREIGN KEY (property_id) REFERENCES storme.host_db(property_id) ON DELETE CASCADE,
    FOREIGN KEY (renter_user_id) REFERENCES storme.user_ppid(id) ON DELETE CASCADE
);
